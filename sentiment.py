...
def get_stock_news(stock_name):
    ...
    return gnews_articles + google_articles
...
def sentiment_func():
    ...
    stock_name = st.text_input("Enter the stock name (e.g., 'Reliance Industries'):")
    ...
    if st.button("Analyze Sentiment"):
        if stock_name:
            ...
            if sentiment_data:
                ...
                # Display as an interactive table with clickable links
